...
const DeleteExpenses = ({ showModalDelete, setShowModalDelete, userInfo, setDone }) => {

  const dispatch = useDispatch()
  const deleteUser = () => {
    
    const api = `https://app.medical-clinic.tk/api/expenses/${userInfo.id}/delete`;
            ...
            <div className="mt-3 sm:flex">
              ...
              <div className="mt-2 text-center sm:ml-4 sm:text-left">
                ...
                <p className="mt-2 text-[15px] leading-relaxed text-gray-500">
                  Are You Sure ! 
                  You Will Delete Him From and You will cann't back Him
                </p>
